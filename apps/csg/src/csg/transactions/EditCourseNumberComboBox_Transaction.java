 ...
 * @author Ajay
 */
public class EditCourseNumberComboBox_Transaction implements jTPS_Transaction {
    CSGApp app;
    CSGData d;
    SiteData data;
    ComboBox c;
    ...
    public EditCourseNumberComboBox_Transaction(CSGApp initApp, CSGData d, SiteData data, ComboBox c, String old, String n){
        app = initApp;
        this.d = d;
        this.data = data;
        this.c = c;
