 ...
 * @author Ajay
 */
public class MTRemoveRecitation_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ...
    public MTRemoveRecitation_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, RecitationPrototype removed){
        app = initApp;
        this.d = d;
        this.data = data;
