...
public class MT_RecEditDayTimeColumn_Transaction implements jTPS_Transaction{
    ...
    public MT_RecEditDayTimeColumn_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, String old, String n){
        app = initApp;
        this.d = d;
        this.data = data;
        this.old = old;
    ...
    public void doTransaction() {
        ...
        newRecitation = data.editRecitation(r, "DAYTIME", n);
        recTable.refresh();
    }
