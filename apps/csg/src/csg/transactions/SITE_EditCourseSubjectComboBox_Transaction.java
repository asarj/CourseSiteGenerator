 ...
 * @author Ajay
 */
public class SITE_EditCourseSubjectComboBox_Transaction implements jTPS_Transaction {
    CSGApp app;
    CSGData d;
    SiteData data;
    ComboBox c;
    ...
    public SITE_EditCourseSubjectComboBox_Transaction(CSGApp initApp, CSGData d, SiteData data, ComboBox c){
        app = initApp;
        this.d = d;
        this.data = data;
        this.c = c;
