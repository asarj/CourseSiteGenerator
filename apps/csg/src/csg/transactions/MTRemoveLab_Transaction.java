 ...
 * @author Ajay
 */
public class MTRemoveLab_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ...
    public MTRemoveLab_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, LabPrototype removed){
        app = initApp;
        this.d = d;
        this.data = data;
