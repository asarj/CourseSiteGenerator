 ...
 * @author Ajay
 */
public class MTLabEditRoomColumn_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ...
    public MTLabEditRoomColumn_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, String old, String n){
        app = initApp;
        this.d = d;
        this.data = data;
        this.old = old;
