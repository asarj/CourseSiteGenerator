 ...
 * @author Ajay
 */
public class MTRecEditTA2Column_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ...
    public MTRecEditTA2Column_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, String old, String n){
        app = initApp;
        this.d = d;
        this.data = data;
        this.old = old;
