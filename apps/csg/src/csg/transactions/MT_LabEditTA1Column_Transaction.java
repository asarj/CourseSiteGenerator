 ...
 * @author Ajay
 */
public class MT_LabEditTA1Column_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ...
    public MT_LabEditTA1Column_Transaction(CSGApp initApp, CSGData d, MeetingTimesData data, LabPrototype l, String old, String n){
        app = initApp;
        this.d = d;
        this.data = data;
        this.newLab = l;
    ...
    public void doTransaction() {
        ...
        newLab = data.editLab(newLab, "TA1", n);
        labTable.refresh();
    }
