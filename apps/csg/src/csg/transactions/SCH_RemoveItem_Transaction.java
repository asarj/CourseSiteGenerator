 ...
 * @author Ajay
 */
public class SCH_RemoveItem_Transaction implements jTPS_Transaction{
    CSGApp app;
    CSGData d;
    ScheduleData data;
    ScheduleItemPrototype s;
    
    public SCH_RemoveItem_Transaction(CSGApp initApp, CSGData d, ScheduleData data, ScheduleItemPrototype s){
        app = initApp;
        this.d = d;
        this.data = data;
        this.s = s;
